    ...
    class Pagination
{
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li class="lii"><a class="a" href="'.$this->__link('1').'">First</a></li>';
                $p .= '<li class="lii"><a class="a" href="'.$this->__link($this->_config['current_page']-1).'">Prev</a></li>';
            }
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="lii"><span class="sp">'.$i.'</span></li>';
                }
                else{
                    $p .= '<li class="lii"><a class="a" href="'.$this->__link($i).'">'.$i.'</a></li>';
                }
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li class="lii"><a class="a" href="'.$this->__link($this->_config['current_page'] + 1).'">Next</a></li>';
                $p .= '<li class="lii"><a class="a" href="'.$this->__link($this->_config['total_page']).'">Last</a></li>';
            }
