<?php
    ...
    $p = new cNhomNS();
    // $a = new ctaikhoan();
    $table = $p-> select_nhomnongsan_byid($MaNhomNongSan);
?> 
 ...
 <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <h3 style="text-align:center">Cập nhật thông tin nhóm nông sản</h3>
                ...
                <div class="row-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <td><input type='text'class='form-control' name='txtmanhomnongsan' value="<?php echo $row['MaNhomNongSan'] ?>" readonly></td>
                        <td>Tên nhóm nông sản</td>
                        <td><input type='text'class='form-control' name='txttennhomnongsan' value="<?php echo $row['TenNhomNongSan'] ?>"></td>
                    </div>
                  </div>
                  <div class="col-md-4">
  ...
  <?php
    if(isset($_REQUEST["submit"])){
        $MaNhomnNongSan=$_REQUEST["txtmanhomnongsan"];
        $TenNhomNongSan=$_REQUEST["txttennhomnongsan"];
        $p = new cNhomNS();
        $table=$p->update_nhomnongsan($MaNhomnNongSan, $TenNhomNongSan);
        if ($table==1) {
            echo "<script>alert('Cập nhật thành công');</script>";
            echo "<script>window.location.href='?qlnhomns'</script>";
        }else {
