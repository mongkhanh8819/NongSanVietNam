 ...
 <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <h3 style="text-align:center">Thêm Nhóm Nông Sản</h3>
              <form action="#" method='post'>
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="tennhomnongsan" placeholder="Enter Tên nhóm nông sản" name="tennhomnongsan"></br>
                  </div>
                  <div class="col-md-4">
  ...
  <?php
    if(isset($_REQUEST["submit"])){
      ...
      $TenNhomNongSan=$_REQUEST["tennhomnongsan"];
      $p=new cNhomNS();
        $table=$p-> add_nhomnongsan($TenNhomNongSan);
        if($table==1){
