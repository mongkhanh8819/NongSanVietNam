        ...
        <div class="p-3 py-5">
          	...
          	<?php 
          		...
          		if ($tt) {
          			while ($row = mysqli_fetch_array($tt)) {
          				?>
          <div class="col-mt-12"><label class="labels">Tên người đại diện</label>
          ...
          <div class="row mt-6">
            ...
            <div class="col-md-6"><label class="labels">Email người đại diện</label>
              <input type="email" class="user-infor form-control" placeholder="Nhập Email người đại diện" name="emailndd" value="<?php echo $row['EmailNDD'] ?>">
            </div>
            ...
            <div class="col-md-12"><label class="labels">Địa chỉ người đại diện</label>
              <input type="text" class="user-infor form-control" placeholder="Nhập địa chỉ nhà cung cấp" name="diachindd" value="<?php echo $row['DiaChi_NDD'] ?>">
            </div>
